...
public interface ClubRepository extends JpaRepository<Club, UUID> {
    ...
    @Query(value = "SELECT * FROM clubs WHERE search_vector @@ plainto_tsquery('english', :query) ORDER BY ts_rank(search_vector, plainto_tsquery('english', :query)) DESC LIMIT :limit", nativeQuery = true)
