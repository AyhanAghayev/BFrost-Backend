...
class EventServiceTest {
    ...
    @BeforeEach
    void setUp() {
        eventService = new EventService(eventRepository, rsvpRepository, clubRepository, membershipRepository, userRepository);
    }
    ...
    @Test
    void rsvpRejectsWhenEventIsFull() {
        ...
        assertThatThrownBy(() -> eventService.rsvp(eventId, userId, RsvpStatus.ATTENDING))
    ...
    void rsvpAllowsDecliningEvenWhenFull() {
        ...
        eventService.rsvp(eventId, userId, RsvpStatus.NOT_ATTENDING);
